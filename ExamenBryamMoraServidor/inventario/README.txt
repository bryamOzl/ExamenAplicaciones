...
a persistence unit "inventarioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "inventario\pom.xml":
...
artifact ("inventario.war") is already built. You can build
